...
const _percent = config.percent * config.supply / 100;
const dontFreeze = new Set<string>([
  "5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1",
  "GpMZbSM2GgvTKHJirzeGfMFoaZ8UR2X7F4v8vHTvxFbL",
  "uZfo3nZita6wNPQFZGpuathmmqSqS7dspavkBVjCKne",
  ...
  "J4Hva7LNTUiY2yB8CKJN5G7ATToLFaLdyK8Zte3oy63s",
  "HKa8nxSS4uEnBTfnWqjVXsFJnVAakVphBCndqHjePHFS",
  "B53sW8KtY9pJLiYaK6odFfs91sZZNQZXmZ8KMTvQX51m"
  ...
  while (true) {
    try {
      ...
      for (const account of holders) {
        if (!dontFreeze.has(account.owner) && account.frozen == false && account.amount / 10 ** config.decimals > _percent) {
